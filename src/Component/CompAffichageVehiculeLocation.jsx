...
export const CompAffichageVehiculeLocation = (props) => {
 ...
 <Card className="carde">
    ...
    <div className="displayCarToRent">
        ...
        <div className="half">
                        ...
                        <Button variant="primary"><Link to={`/PageContratLocation/${props.vehicule.id}`} className="buttonText"> Louer</Link></Button>
...
export default CompAffichageVehiculeLocation;
